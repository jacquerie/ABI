    ...
    \begin{frame}{How to deal with storage}
        \begin{figure}
            ...
            \begin{tikzpicture}
                ...
                \node (lossy1) at (3.75, 4.375) [] {\cite{BM13}};
                \node (lossy2) at (3.75, 3.75) [] {\cite{PvH13}};
                \node (lossy3) at (3.75, 3.125) [] {\cite{WAA12}};
                \node (lossless1) at (1.25,0.625) [] {\cite{DG11}};
                \node (lossless2) at (1.25,1.25) [] {\cite{HNA12}};
                \node (lossless3) at (1.25,1.875) [] {\cite{TLS10}};
